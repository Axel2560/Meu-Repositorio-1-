...
const CriarTarefa = ({handleClose, tarefas, setTarefas, getTarefas}) =>{
  ...
  const handleSalvar = () => {
    ...
    console.log(`titulo: ${tarefaTitulo} \n descrição: ${tarefaDescricao} \n 
      inicio: ${tarefaInicio} \n fim: ${tarefaFim} \n recurso: ${recursoId} \n 
    ...
    .then(result => { 
      console.log('result data cad tarefa: ' + JSON.stringify(result.data));
